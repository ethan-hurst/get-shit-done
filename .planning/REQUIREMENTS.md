...
- [ ] **TEST-13**: config.cjs has tests for config-ensure-section, config-set, config-get
- [ ] **TEST-14**: template.cjs has tests for template select heuristics and template fill
- [ ] **TEST-15**: milestone.cjs has extended tests for milestone complete with archiving
